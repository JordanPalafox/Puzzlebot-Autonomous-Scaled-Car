#!/usr/bin/env python3
"""
Behavior para seguimiento de línea rápido usando OpenCV.
"""
...
class FollowLineFast(py_trees.behaviour.Behaviour):
    def __init__(self, name="FollowLineFast", node=None):
        ...
        self.linear_speed = 0.08  # Velocidad rápida
        self.max_angular_speed = 0.18
    ...
    def setup(self, **kwargs):
        if self.node:
            ...
            self.node.get_logger().info("FollowLineFast behavior configurado")
        return True
    ...
    def update(self):
        # El behavior siempre está corriendo mientras recibe imágenes
        return py_trees.common.Status.RUNNING
    
    def terminate(self, new_status):
        self.stop_robot()
        if self.node:
            self.node.get_logger().info("Terminando seguimiento de línea rápido")
