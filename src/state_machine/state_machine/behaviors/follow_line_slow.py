...
class FollowLineSlow(py_trees.behaviour.Behaviour):
    def __init__(self, name="FollowLineSlow", node=None):
        ...
        self.roi_height = 60        # ROI más pequeño para respuesta lenta
        ...
        self.max_angular = 0.10     # Giros más agresivos
        ...
        self.error_buffer = []
        self.buffer_size = 3       # Buffer más pequeño para respuesta lenta
    ...
    def setup(self, **kwargs):
        if self.node:
            ...
            self.node.get_logger().info("🚀 FollowLineSlow behavior robusto configurado")
        return True
    ...
    def preprocess_image(self, image):
        """Preprocesamiento robusto optimizado para velocidad lenta"""
        ...
        # ROI optimizado para velocidad lenta
    ...
    def find_line_centroid(self, binary_image):
        """Encuentra centroide optimizado para velocidad lenta"""
    ...
    def smooth_error(self, error):
        """Suavizado optimizado para respuesta lenta"""
        self.error_buffer.append(error)
        if len(self.error_buffer) > self.buffer_size:
            self.error_buffer.pop(0)
        
        # Menos suavizado para respuesta más lenta
    ...
    def calculate_control(self, error):
        """Control PID optimizado para velocidad lenta"""
        smooth_err = self.smooth_error(error)
        
        # PID con ganancias para velocidad lenta
    ...
    def image_callback(self, msg):
        """Callback principal optimizado para velocidad lenta"""
        try:
            # Decodificar imagen
            ...
            if centroid is not None:
                # Línea detectada - control agresivo para velocidad lenta
                self.no_line_count = 0
                ...
                if self.frame_count % 3 == 0:
                    ...
                    cv2.putText(debug_roi, 'SLOW MODE', (10, 25), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)
